...
\pagestyle{fancy}
\lfoot{	\footnotesize 
		RITMO Bodies in Concert, participant report\\
...
\newcommand{\JournalName}[1]{%
		...
		\begin{center}	
		\noindent\raisebox{\dimexpr2.1\baselineskip-\height}{\includegraphics[height=0.5in]{RITMO-hovedmerke-290818_150px.png}}
